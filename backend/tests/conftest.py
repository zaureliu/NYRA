...
os.environ.setdefault("KAZUMI_TESTING", "true")
...
# ---------------------------------------------------------------------------
os.environ.setdefault("KAZUMI_AGENT_READ_ONLY", "false")
os.environ.setdefault("KAZUMI_PROACTIVE_OPERATOR_ENABLED", "false")
_TEST_SESSION_ROOT = Path(tempfile.gettempdir()) / "kazumi-pytest"
os.environ.setdefault("KAZUMI_DATA_HOME", str(_TEST_SESSION_ROOT / "runtime"))
os.environ.setdefault(
    "KAZUMI_SELFDEV_WORKSPACE",
    str(_TEST_SESSION_ROOT / "selfdev" / "workspace"),
)
os.environ.setdefault(
    "KAZUMI_PUBLIC_SNAPSHOT",
    str(_TEST_SESSION_ROOT / "selfdev" / "public"),
)

# ---------------------------------------------------------------------------
# Controlled basetemp under the hermetic KAZUMI test runtime. Generic
...
_TEST_TEMP_ROOT = Path(os.environ["KAZUMI_DATA_HOME"]) / "tmp" / "pytest-root"

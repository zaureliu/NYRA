...
| Chatterbox | `nyra_reference` | depende de WAV autorizado | arquitetura pronta; nenhum WAV fornecido |
...
O perfil oficial existente continua apontando para Edge Thalita; esta etapa não alterou `NYRA_VOICE` automaticamente.

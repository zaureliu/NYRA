...
- provider: `kokoro`; voz: `pf_dora`; idioma: pt-BR; perfil `NYRA_VOICE`.
...
- Não há alteração artificial de pitch nem referência de pessoa real. `data/voices/nyra_reference.wav` é opcional e ignorado pelo Git.
